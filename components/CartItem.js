...
function CartItem({ item, id }) {
  ...
  return (
    <div className="m-auto flex flex-col gap-2  p-4 rounded-sm shadow-sm bg-[white/[0.5]] mb-2 max-w-xl">
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-1 sm:gap-3  ">
                <button
                  ...
                  className=" border border-[#252525]  py-1.5   rounded-full px-6 hover:bg-[#252525] hover:text-white transition  text-xs sm:text-sm mt-2 max-w-xs disabled:cursor-not-allowed"
                >
                  Remove from Bag
                </button>
              </div>
